...
<!-- NOTE: The sample is intentionally minimal — 5 rules, not 50.
     ...
     TODO: Mention that a company-level resources like a claude.md should be created and shared.
-->
...
<!-- TODO: Add a simple explanation of how to install skills through
     Claude desktop app interface using Cowork customize and Claude code to use `npx skills`
-->
...
<!-- TODO: Add a quick explanation that GIT is the history of changes made to a project
     and github is a platform that allows multiple people to share and colaborate
     on changing documents like code or texts.-->
